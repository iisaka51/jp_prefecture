...
assert ( city.name2citycode('京都市') == 26100 )
assert ( city.name2citycode('京都市', with_checkdigit=True) == 261009 )
...
assert ( city.name2prefcode('京都市') == 26 )
assert ( city.name2prefcode(['京都市北区', '大阪市中央区']) == [26, 27] )

assert ( city.name2prefecture('京都市') == '京都府' )
